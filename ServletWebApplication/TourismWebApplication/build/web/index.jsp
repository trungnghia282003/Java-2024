                ...
                <form id="searchForm">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="dichVuDropdown">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="giaDropdown">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="thanhPhoDropdown" name="thanhPhoDropdown" onchange="onCityChange()">
                                <option value="" selected disabled>Hãy chọn thành phố</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="quanDropdown" name="quanDropdown" onchange="onDistrictChange()" disabled>
                                <option value="" selected disabled>Hãy chọn quận</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="phuongDropdown" name="phuongDropdown" disabled>
                                <option value="" selected disabled>Hãy chọn phường</option>
        ...
        function submitForm() {
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    // Cập nhật nội dung của table
                    updateTable(response);
                }
            };
            xhttp.open("GET", "http://localhost:8080/ServletWebApplication/dulichvietnam?" + new URLSearchParams(formData).toString(), true);
            xhttp.send();
        }

        function updateTable(data) {
            var table = document.getElementById("diaDiemTable");
            ...
            data.forEach(function (diaDiem) {
                ...
                cell1.innerHTML = diaDiem.tenDiaDiem;
                cell2.innerHTML = diaDiem.phuong.tenPhuong;
                cell3.innerHTML = diaDiem.phuong.quan.tenQuan;
                cell4.innerHTML = diaDiem.phuong.quan.thanhPho.tenThanhPho;
                cell5.innerHTML = diaDiem.dichVu.tenDichVu;
                cell6.innerHTML = diaDiem.gia.mucGia;
            });
        }
